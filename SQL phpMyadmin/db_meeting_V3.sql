...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2022 at 08:51 AM
...
(5, 'โครงการอบรมและพัฒนางาน', '2022-04-01', '2022-04-01', '13:00:00', '16:00:00', '#FFFFFF', '2021-04-08 02:30:23', 20, 4, '', '#FFFFFF', '', '640400003', 3, 0x9105bb0b6745447b4890d6e424d4de22, 4, ''),
...
(33, 'ทดสอบของซ้ำ', '2022-04-02', '2022-04-02', '14:58:00', '14:58:00', '#FFFFFF', '2022-04-02 07:58:34', 20, 3, '', '#FFFFFF', '', '650400002', 2, 0x9105bb0b6745447b4890d6e424d4de22, 1, NULL),
(31, 'test', '2022-04-03', '2022-04-03', '13:59:00', '13:59:00', '#FFFFFF', '2022-04-02 06:59:24', 20, 3, '', '#FFFFFF', '', '650400001', 1, 0x9105bb0b6745447b4890d6e424d4de22, 1, 'zoom'),
(35, 'ทดสอบ เวลา', '2022-03-27', '2022-03-27', '20:53:00', '21:53:00', '#FFFFFF', '2022-04-02 08:15:35', 22, 1, '', '#FFFFFF', '', '650300002', 3, 0x9105bb0b6745447b4890d6e424d4de22, 2, 'zoom');
...
CREATE TABLE `tbl_rooms` (
  ...
  `ro_peoplemini` int(11) DEFAULT NULL,
...
(1, 'ห้องประชุมแสงจันทร์', 350, 200, '#00ffaa', 'ตึกผู้ป่วยนอก ชั้น 4', 'Y'),
(2, 'ห้องประชุมแสงตะวัน', 50, 20, '#3bd5e7', 'ห้องประชุม 0', 'Y'),
(3, 'ห้องประชุมแสงดาว', 200, 100, '#d84dff', 'ห้องประชุม1', 'Y'),
(4, 'ห้องประชุม 2', 20, 0, '#ece869', 'ห้องประชุม2', 'Y'),
(5, 'ห้องประชุมดอกปีบ', 150, 70, '#ff6b6b', 'ห้องประชุม3', 'Y'),
...
CREATE TABLE `tbl_setdevice` (
  ...
  `ward_id` int(10) NOT NULL COMMENT 'ward',
...
INSERT INTO `tbl_setdevice` (`dv_id`, `ward_id`, `setstatus`) VALUES
(2, 69, 'Y');
...
(17, 'ทดสอบใหม่', 114, 69, 4),
(18, 'อุปกรณ์ ward 48', 114, 48, 4);
...
--
ALTER TABLE `tbl_event`
  MODIFY `ev_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `tbl_tools`
  MODIFY `to_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
