    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modaldata">
                ...
                <div class="form-group row  mb-2">
                    <div class="input-group">
                        <label class="col-md-2 col-form-label ">ตั้งแต่ :</label> <span class="col-form-label col-md" id="modal2_starttime"></span>

                        <label class="col-md-2 col-form-label ">ถึง :</label> <span class="col-form-label col-md" id="modal2_endtime"></span>
                    </div>
                </div>
                <div class="form-group row  mb-2">
